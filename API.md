...
| xx_eone_jwglxtdl                                  | ✅ | STR username STR password \[STR cookies\] \[BOOL intranet\]                         |教务系统登录，cookies是通过webvpn访问|
| xx_eone_jxzhptdl                                  | ✅ | STR username STR password \[STR cookies\] \[BOOL intranet\]                         |M福医大登录，cookies是通过webvpn访问|
...
| xx_ehall_jbxxdl                                   | ✅ | STR username STR password STR cookies \[BOOL intranet\]                             |基本信息登录，ehall的cookies，默认webvpn访问|
